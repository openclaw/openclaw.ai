...
const channelCatalog: CatalogItem[] = [
  ...
  { name: 'iMessage', desc: 'Native macOS messaging through the imsg bridge.', docs: 'https://docs.openclaw.ai/channels/imessage', icon: siIcon(siApple), color: '#007AFF', status: 'included' },
  { name: 'IRC', desc: 'Classic IRC channels and DMs with access controls.', docs: 'https://docs.openclaw.ai/channels/irc', icon: 'lucide:hash', color: '#F59E0B', status: 'included' },
  { name: 'LINE', desc: 'LINE Messaging API bot conversations.', docs: 'https://docs.openclaw.ai/channels/line', icon: siIcon(siLine), color: '#06C755', status: 'official' },
  { name: 'Matrix', desc: 'Rooms and direct messages over Matrix.', docs: 'https://docs.openclaw.ai/channels/matrix', icon: siIcon(siMatrix), color: 'currentColor', status: 'official' },
  { name: 'Mattermost', desc: 'Channels, groups, and DMs over Bot API and WebSocket.', docs: 'https://docs.openclaw.ai/channels/mattermost', icon: siIcon(siMattermost), color: '#0058CC', status: 'included' },
  { name: 'Microsoft Teams', desc: 'Enterprise conversations through Bot Framework.', docs: 'https://docs.openclaw.ai/channels/msteams', icon: 'lucide:users', logo: '/integrations/logos/microsoft-teams.svg', color: '#6264A7', status: 'official' },
  ...
  { name: 'Synology Chat', desc: 'Synology NAS chat through incoming and outgoing webhooks.', docs: 'https://docs.openclaw.ai/channels/synology-chat', icon: 'lucide:server-cog', logo: '/integrations/logos/synology.svg', color: '#B6D957', status: 'official' },
  { name: 'Telegram', desc: 'Bot API conversations, groups, and rich media.', docs: 'https://docs.openclaw.ai/channels/telegram', icon: siIcon(siTelegram), color: '#26A5E4', status: 'included' },
  { name: 'Tlon', desc: 'Urbit-based messaging for chat workflows.', docs: 'https://docs.openclaw.ai/channels/tlon', icon: 'lucide:network', logo: '/integrations/logos/urbit.svg', color: '#F0F4FF', status: 'official' },
  { name: 'Twitch', desc: 'Live chat and moderation workflows.', docs: 'https://docs.openclaw.ai/channels/twitch', icon: siIcon(siTwitch), color: '#9146FF', status: 'official' },
  { name: 'Voice Call', desc: 'Phone conversations through Twilio, Telnyx, or Plivo.', docs: 'https://docs.openclaw.ai/plugins/voice-call', icon: 'lucide:mic', color: '#F97316', status: 'official' },
  { name: 'WebChat', desc: 'Gateway-hosted browser chat over WebSocket.', docs: 'https://docs.openclaw.ai/web/webchat', icon: 'lucide:globe', color: '#00E5CC', status: 'built-in' },
  { name: 'WeChat / Weixin', desc: 'Tencent iLink messaging through QR login.', docs: 'https://docs.openclaw.ai/channels/wechat', icon: siIcon(siWechat), color: '#07C160', status: 'external' },
  { name: 'WhatsApp', desc: 'WhatsApp Web chats through QR pairing.', docs: 'https://docs.openclaw.ai/channels/whatsapp', icon: siIcon(siWhatsapp), color: '#25D366', status: 'official' },
  { name: 'Yuanbao', desc: 'Tencent Yuanbao bot conversations.', docs: 'https://docs.openclaw.ai/channels/yuanbao', icon: 'lucide:bot', logo: '/integrations/logos/yuanbao.svg', color: '#00CC70', status: 'external' },
  { name: 'Zalo', desc: 'Zalo Bot API chats and webhooks.', docs: 'https://docs.openclaw.ai/channels/zalo', icon: siIcon(siZalo), color: '#0068FF', status: 'official' },
  { name: 'Zalo ClawBot', desc: 'Owner-bound personal Zalo assistant through QR login.', docs: 'https://docs.openclaw.ai/channels/zaloclawbot', icon: siIcon(siZalo), color: '#00A8FF', status: 'external' },
  { name: 'Zalo Personal', desc: 'Personal-account messaging through native zca-js.', docs: 'https://docs.openclaw.ai/channels/zalouser', icon: siIcon(siZalo), color: '#0068FF', status: 'official' },
];

const channelStatusRank: Record<CatalogStatus, number> = {
  'built-in': 0,
  included: 0,
  official: 1,
  external: 2,
...
export const channels = [...channelCatalog].sort((left, right) => {
  return channelStatusRank[left.status] - channelStatusRank[right.status]
    || left.name.localeCompare(right.name);
});

export const featuredProviders: CatalogItem[] = [
  { name: 'Anthropic', desc: 'Claude API and Claude CLI with API-key and subscription-backed routes.', docs: 'https://docs.openclaw.ai/providers/anthropic', icon: siIcon(siAnthropic), color: '#D4A574', status: 'included' },
  { name: 'OpenAI', desc: 'OpenAI API plus ChatGPT/Codex sign-in and native Codex execution.', docs: 'https://docs.openclaw.ai/providers/openai', icon: openAiIcon, color: '#00A67E', status: 'included' },
  { name: 'Google', desc: 'Gemini API and CLI OAuth across chat, search, media, and voice.', docs: 'https://docs.openclaw.ai/providers/google', icon: siIcon(siGoogle), color: '#4285F4', status: 'included' },
  { name: 'xAI', desc: 'Grok OAuth and API routes with search, code, image, video, and speech.', docs: 'https://docs.openclaw.ai/providers/xai', icon: siIcon(siX), color: 'currentColor', status: 'included' },
  { name: 'MiniMax', desc: 'Coding Plan OAuth and API-key routes across chat and generated media.', docs: 'https://docs.openclaw.ai/providers/minimax', icon: siIcon(siMinimax), color: '#F0568A', status: 'included' },
  { name: 'Z.AI', desc: 'GLM models through Coding Plan and general API routes.', docs: 'https://docs.openclaw.ai/providers/zai', icon: zAiIcon, color: '#00C8A0', status: 'included' },
  { name: 'Moonshot / Kimi', desc: 'Kimi general models and a separate coding-focused provider.', docs: 'https://docs.openclaw.ai/providers/moonshot', icon: siIcon(siMoonshotai), color: '#8B8CFF', status: 'included' },
  { name: 'Qwen', desc: 'Qwen Cloud, Coding Plan, and Portal token flows.', docs: 'https://docs.openclaw.ai/providers/qwen', icon: siIcon(siQwen), color: '#7357FF', status: 'official' },
];
...
export const capabilities: CatalogItem[] = [
  { name: 'Web and browser', desc: 'Search, fetch readable pages, inspect X, and operate browser sessions.', docs: 'https://docs.openclaw.ai/tools/web', icon: 'lucide:globe', color: '#4FA8FF', status: 'built-in' },
  { name: 'Files and code', desc: 'Read, write, patch, run commands, and use provider-backed code execution.', docs: 'https://docs.openclaw.ai/tools', icon: 'lucide:terminal', color: '#F6C65B', status: 'built-in' },
  { name: 'Messaging actions', desc: 'Reply, react, route, and send through connected channels.', docs: 'https://docs.openclaw.ai/tools/agent-send', icon: 'lucide:message-circle', color: '#00E5CC', status: 'built-in' },
  { name: 'Agents and sessions', desc: 'Delegate, steer, coordinate ACP harnesses, and track goals.', docs: 'https://docs.openclaw.ai/tools/subagents', icon: 'lucide:network', color: '#A98BFF', status: 'built-in' },
  { name: 'Generated media', desc: 'Create images, videos, music, and spoken replies with provider failover.', docs: 'https://docs.openclaw.ai/tools/media-overview', icon: 'lucide:image', color: '#FF72A6', status: 'built-in' },
  { name: 'Tool Search', desc: 'Discover and call large eligible tool catalogs without loading every schema.', docs: 'https://docs.openclaw.ai/tools/tool-search', icon: 'lucide:search', color: '#F97316', status: 'built-in' },
  { name: 'Automation', desc: 'Schedule, monitor, trigger, and audit work in the background.', docs: 'https://docs.openclaw.ai/automation', icon: 'lucide:clock', color: '#65D6C5', status: 'built-in' },
  { name: 'Plugins and skills', desc: 'Add channels, providers, tools, hooks, workflows, and reusable instructions.', docs: 'https://docs.openclaw.ai/tools/plugin', icon: 'lucide:plug', color: '#FF7A7A', status: 'built-in' },
];
...
export const gatewayHosts: CatalogItem[] = [
  { name: 'macOS', desc: 'Run the Gateway locally or connect the menu-bar companion to a remote Gateway.', docs: 'https://docs.openclaw.ai/platforms/macos', icon: siIcon(siApple), color: 'currentColor', status: 'gateway' },
  { name: 'Windows', desc: 'Use Windows Hub, native PowerShell, or a WSL2-hosted Gateway.', docs: 'https://docs.openclaw.ai/platforms/windows', icon: 'lucide:monitor', logo: '/integrations/logos/windows.svg', color: '#3B82F6', status: 'gateway' },
  { name: 'Linux', desc: 'Fully supported Gateway host with systemd service management.', docs: 'https://docs.openclaw.ai/platforms/linux', icon: siIcon(siLinux), color: '#FCC624', status: 'gateway' },
  { name: 'VPS and cloud', desc: 'Deploy on Fly.io, Hetzner, GCP, Azure, exe.dev, EasyRunner, and more.', docs: 'https://docs.openclaw.ai/platforms', icon: 'lucide:cloud', color: '#65D6C5', status: 'gateway' },
];

export const companionNodes: CatalogItem[] = [
  { name: 'macOS app', desc: 'Menu bar, notifications, Canvas, camera, screen, and system tools.', docs: 'https://docs.openclaw.ai/platforms/macos', icon: siIcon(siApple), color: 'currentColor', status: 'node' },
  { name: 'Windows Hub', desc: 'Setup, tray status, chat, node mode, camera, screen, and speech.', docs: 'https://docs.openclaw.ai/platforms/windows', icon: 'lucide:monitor', logo: '/integrations/logos/windows.svg', color: '#3B82F6', status: 'node' },
  { name: 'iOS node', desc: 'Canvas, screen snapshot, camera, location, Talk mode, and Voice Wake.', docs: 'https://docs.openclaw.ai/platforms/ios', icon: siIcon(siIos), color: '#007AFF', status: 'node' },
  { name: 'Android node', desc: 'Official companion node for chat, voice, Canvas, screen, and camera.', docs: 'https://docs.openclaw.ai/platforms/android', icon: siIcon(siAndroid), color: '#34A853', status: 'node' },
];
