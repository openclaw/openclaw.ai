...
const channelCatalog: CatalogItem[] = [
  { name: 'ClickClack', desc: 'Self-hosted ClickClack workspaces through first-class bot tokens.', docs: 'https://docs.openclaw.ai/channels/clickclack', icon: 'lucide:message-circle', logo: '/integrations/logos/clickclack.svg', color: '#FF6B4A' },
  ...
  { name: 'Raft', desc: 'Raft External Agents through the Raft CLI wake bridge.', docs: 'https://docs.openclaw.ai/channels/raft', icon: 'lucide:workflow', logo: '/integrations/logos/raft.svg', color: '#FBF6EE' },
