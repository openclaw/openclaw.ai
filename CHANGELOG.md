...
- Dependencies: update js-yaml to 5.2.1, RSS to 4.0.19, Simple Icons to 16.25.0, and Sharp to 0.35.3; update Astro-compatible Lucide icons to 1.24.0 and preserve the existing generated HTML whitespace behavior (#172, #176, #206, thanks @dependabot).
